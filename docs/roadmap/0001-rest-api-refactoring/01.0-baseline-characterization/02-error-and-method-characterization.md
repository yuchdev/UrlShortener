# 02 - Characterize method and error behavior
...
- [x] `tests/unit/http/03_method_and_error_characterization.cpp` exists and
      covers every wrong-method and validation case listed above.
- [x] Current behavior is asserted even where it is not ideal REST semantics.
- [x] Wrong-method responses remain `400 invalid_method` in this task (not
      changed to `405`).
