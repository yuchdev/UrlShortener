# 01 - Characterize the REST endpoint matrix
...
- [x] `tests/unit/http/02_endpoint_matrix_characterization.cpp` exists and
      registers every endpoint listed above.
- [x] Tests pass before any router dispatch changes.
- [x] No production files are changed by this task.
- [x] The test file is registered under the `unit` CTest label - part of the
      148/148 passing full unit suite and the 29/29 passing HTTP/router
      subset (`ctest -R "^0[1-9]_|^1[0-4]_" -L unit`).
