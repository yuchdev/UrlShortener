...
## Required Components
- `qa/scripts/sections/06_authentication.sh`
...
```bash
bash qa/scripts/sections/06_authentication.sh
```
...
```bash
python3 -m tools.sqlite_state_assert --db qa/tmp/qa.sqlite --expect qa/expected/06_authentication.json
```
