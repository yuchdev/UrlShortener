...
```bash
bash tests/e2e/scripts/sections/03_redirects.sh
```
...
```bash
python3 -m tools.sqlite_state_assert --db tests/e2e/tmp/qa.sqlite --expect tests/e2e/expected/03_redirects.json
```
