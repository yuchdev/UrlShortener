...
``URL_SHORTENER_PROD_CONFIRMED=1`` in the environment before launching Claude Code.
...
def main() -> None:
    ...
    if PROD.search(command) and os.environ.get("URL_SHORTENER_PROD_CONFIRMED") != "1":
        ...
        block(
            ...
            f"Command: {command}\n"
            "Set URL_SHORTENER_PROD_CONFIRMED=1 in the environment to authorise production "
