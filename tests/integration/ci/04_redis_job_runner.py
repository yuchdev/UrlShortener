...
res = subprocess.run([
    "ctest", "-R",
    "redis__|ratelimiter__|with_redis|01_set_get_delete_ttl|02_unavailable_redis_fail_open"
    "|03_serialization_version_compatibility|04_ratelimiter_fixed_window|05_ratelimiter_concurrency"
    "|storage__13_",
    "--output-on-failure",
], check=False)
