...
#include "url_shortener/storage/sql/sql_dialect.hpp"

/**
 * @brief SQLite SQL dialect implementation for metadata statements.
 */
class SqliteSqlDialect final : public SqlDialect {
public:
