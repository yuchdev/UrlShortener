...
_deps/yaml-cpp-build/util/CMakeFiles/yaml-cpp-sandbox.dir/sandbox.cpp.o: _deps/yaml-cpp-build/util/CMakeFiles/yaml-cpp-sandbox.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --progress-dir=/tmp/workspace/yuchdev/UrlShortener/build_debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object _deps/yaml-cpp-build/util/CMakeFiles/yaml-cpp-sandbox.dir/sandbox.cpp.o"
	cd /tmp/workspace/yuchdev/UrlShortener/build_debug/_deps/yaml-cpp-build/util && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -MD -MT _deps/yaml-cpp-build/util/CMakeFiles/yaml-cpp-sandbox.dir/sandbox.cpp.o -MF CMakeFiles/yaml-cpp-sandbox.dir/sandbox.cpp.o.d -o CMakeFiles/yaml-cpp-sandbox.dir/sandbox.cpp.o -c /tmp/workspace/yuchdev/UrlShortener/build_debug/_deps/yaml-cpp-src/util/sandbox.cpp
...
_deps/yaml-cpp-build/util/CMakeFiles/yaml-cpp-sandbox.dir/sandbox.cpp.i: cmake_force
	...
	cd /tmp/workspace/yuchdev/UrlShortener/build_debug/_deps/yaml-cpp-build/util && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/workspace/yuchdev/UrlShortener/build_debug/_deps/yaml-cpp-src/util/sandbox.cpp > CMakeFiles/yaml-cpp-sandbox.dir/sandbox.cpp.i
...
_deps/yaml-cpp-build/util/CMakeFiles/yaml-cpp-sandbox.dir/sandbox.cpp.s: cmake_force
	...
	cd /tmp/workspace/yuchdev/UrlShortener/build_debug/_deps/yaml-cpp-build/util && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/workspace/yuchdev/UrlShortener/build_debug/_deps/yaml-cpp-src/util/sandbox.cpp -o CMakeFiles/yaml-cpp-sandbox.dir/sandbox.cpp.s
...
_deps/yaml-cpp-build/util/sandbox: _deps/yaml-cpp-build/util/CMakeFiles/yaml-cpp-sandbox.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --bold --progress-dir=/tmp/workspace/yuchdev/UrlShortener/build_debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable sandbox"
	cd /tmp/workspace/yuchdev/UrlShortener/build_debug/_deps/yaml-cpp-build/util && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/yaml-cpp-sandbox.dir/link.txt --verbose=$(VERBOSE)
...
_deps/yaml-cpp-build/util/CMakeFiles/yaml-cpp-sandbox.dir/clean:
	cd /tmp/workspace/yuchdev/UrlShortener/build_debug/_deps/yaml-cpp-build/util && $(CMAKE_COMMAND) -P CMakeFiles/yaml-cpp-sandbox.dir/cmake_clean.cmake
...
_deps/yaml-cpp-build/util/CMakeFiles/yaml-cpp-sandbox.dir/depend:
	cd /tmp/workspace/yuchdev/UrlShortener/build_debug && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/workspace/yuchdev/UrlShortener /tmp/workspace/yuchdev/UrlShortener/build_debug/_deps/yaml-cpp-src/util /tmp/workspace/yuchdev/UrlShortener/build_debug /tmp/workspace/yuchdev/UrlShortener/build_debug/_deps/yaml-cpp-build/util /tmp/workspace/yuchdev/UrlShortener/build_debug/_deps/yaml-cpp-build/util/CMakeFiles/yaml-cpp-sandbox.dir/DependInfo.cmake "--color=$(COLOR)"
