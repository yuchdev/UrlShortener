...
merge-blocking gate. The Stop hook `.github/hooks/scripts/run_tests.py` and the
`.github/hooks/scripts/secret_scan.py` pre-hook are automated backstops - your review is
